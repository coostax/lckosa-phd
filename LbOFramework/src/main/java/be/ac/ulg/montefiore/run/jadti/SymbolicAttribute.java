...
/**
 * Refactoring of SymbolicAttribute A symbolic attribute. Symbolic attributes
 * have a finite set of possible values represented by a positive integer.
 **/
public class SymbolicAttribute extends Attribute {
	 ...
	 * 
	 * @param nbValues
	 *            The numberInPot of different values allowed for this
	 *            attribute. The allowed attribute values are 0...
	 *            <code>nbValues - 1</code>.
	 **/
	...
	public SymbolicAttribute(String name, int nbValues) {
		...
		if (nbValues <= 0)
			throw new IllegalArgumentException("The numberInPot of allowed "
					+ "attribute values must be " + "strictly positive");
